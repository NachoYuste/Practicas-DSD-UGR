...
public class DonacionUno extends UnicastRemoteObject implements  idonacion_servidor, idonacion_cliente{
    ...
    public DonacionUno(String nombre, String nombreReplica) throws RemoteException{

...
def interfazSimple(client):
    ...
    print("Resultado: "+str(val1) + operacion + str(val2) + " = " + str(resultado))
...
while True:
    while True :
        print("\n\nElija la calculadora a utilizar:\n")
        operacion = input("\tSimple -> S\tVector y Escalar -> V\tMatricial -> M\tExit -> E: ")

        if operacion == 'S' or operacion == 'V' or operacion == 'M' or operacion == 'E':
            break
